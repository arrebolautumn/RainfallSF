...
import { CloudRain, LayoutDashboard, Calendar, GitBranch, AlertTriangle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 border-b bg-card/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">Rainfall Analytics</h1>
              <p className="text-sm text-muted-foreground">Historical Data Dashboard (1993-2023)</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="seasonal" className="mt-6 animate-in fade-in-50 duration-300">
            <SeasonalAnalysis />
          </TabsContent>

          <TabsContent value="correlation" className="mt-6 animate-in fade-in-50 duration-300">
            <CorrelationAnalysis />
          </TabsContent>

          <TabsContent value="extreme" className="mt-6 animate-in fade-in-50 duration-300">
            <ExtremeEvents />
          </TabsContent>
        </Tabs>
      </main>
